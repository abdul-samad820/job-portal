...
<head>
    ...
    color: #fff;
    padding: 2.2rem 1.8rem;      /* Reduced padding */
    flex: 0.9;                   /* Slightly smaller left */
    display: flex;
    ...
    object-fit: contain;
        ...
        .right-panel {
            ...
            padding: 2rem 1.6rem;        /* Reduced padding *//* Slightly larger right side */
            background: #fff;
            flex: 1.1;
            display: flex;
            flex-direction: column;
    ...
    <div class="right-panel">
        ...
        <form action="{{route('superadmin.create')}}" method="POST">
            ...
            <div class="form-check mb-3">
                ...
                <label for="agreeTerms">I agree to the <a href="#" class="text-primary">terms & conditions</a></label>
            </div>
