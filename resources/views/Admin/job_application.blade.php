                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.application.updateStatus', $app->id) }}"
                                                    ...
                                                    <!-- Hidden input -->
                                                    <input type="hidden" name="status" id="statusInput{{ $app->id }}"
                                                        value="{{ $app->status }}">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @php
                                                            $profileImage =
                                                                $profile && $profile->profile_image
                                                                    ? Storage::url(
                                                                        'user_profile/' . $profile->profile_image,
                                                                    )
                                                        ...
                                                        <div class="text-center mb-4">
                                                            ...
                                                            <img src="{{ $profileImage }}"
                                                                class="rounded-circle shadow-sm border" width="110"
                                                                height="110"
                                                        ...
                                                        @if ($profile && $profile->core_skills)
                                                            @foreach (explode(',', $profile->core_skills) as $skill)
                                                                <span
                                                                    class="badge badge-info p-2 m-1">{{ trim($skill) }}</span>
                                                            @endforeach
                                                        @else
