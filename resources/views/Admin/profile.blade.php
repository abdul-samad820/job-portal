        ...
        <div class="card-body text-center">
            ...
            <div class="position-relative d-inline-block">
                <img id="previewImage" src="{{ $profile->profile_image
                            ...
                            : asset('admins/dist/img/default.png') }}" class="rounded-circle shadow"
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group text-center">
                    ...
                    <input type="file" name="profile_image" class="form-control-file" onchange="readURL(this);">
                ...
                <div class="form-group">
                    ...
                    <textarea name="expertise" class="form-control" rows="3">{{ $profile->expertise }}</textarea>
                </div>
