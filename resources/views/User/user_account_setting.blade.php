                    ...
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted small">
                                Enter your basic information to complete your profile.
                            </p>
                        </div>
                ...
                <form action="{{ route('user.account_setting_update', $user_data->id) }}" method="POST">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <input type="email" name="email" value="{{ old('email', $user_data->email) }}"
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" name="phone" value="{{ old('phone', $user_data->phone) }}"
