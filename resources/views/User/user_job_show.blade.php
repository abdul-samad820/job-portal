...
<!-- HERO SEARCH HEADER -->
<div class="w-100 py-5" style="margin-top:90px; 
        ...
        <form method="GET" action="{{ route('user.jobs.filter') }}">
            <div class="row justify-content-center">
                ...
                <div class="col-md-3 col-6 mb-2">
                    <input type="text" name="search" class="form-control shadow-sm" style="height:48px; font-size:14px;"
                        placeholder="Job title or company" value="{{ request('search') }}">
                </div>
    ...
    <div class="row">
            ...
            <form method="GET" action="{{ route('user.jobs.filter') }}">
                <div class="p-4 shadow-sm" style="background:white; border-radius:18px; border:1px solid #e5eef6;">
                    ...
                    <div class="form-check mb-1">
                        <input type="checkbox" class="form-check-input" name="job_type[]" value="{{ $jt }}" {{
                    ...
                    <div class="form-check mb-1">
                        <input type="checkbox" class="form-check-input" name="experience[]" value="{{ $exp }}" {{
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <input type="number" name="min_salary" id="minSalary" min="0" max="50"
                            value="{{ request('min_salary','') }}" class="form-control" style="max-width:90px;"
                            placeholder="Min">
                        <span class="mx-2">-</span>
                        <input type="number" name="max_salary" id="maxSalary" min="0" max="50"
                            value="{{ request('max_salary','') }}" class="form-control" style="max-width:90px;"
                            placeholder="Max">
                        <span class="ml-2 small">LPA</span>
                    </div>

                    <input type="range" min="0" max="50" id="salaryRange" value="{{ request('max_salary') ?? 20 }}"
                        class="w-100 mt-2">
        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <form id="sortForm" method="GET" action="{{ route('user.jobs.filter') }}" class="m-0 p-0">
                    ...
                    <div class="premium-select" style="max-width:220px;">
                        ...
                        <select name="sort" class="form-control" onchange="$('#sortForm').trigger('submit');">
            ...
            <div class="card shadow-sm border-0 rounded-lg mb-4 position-relative">
                ...
                <div class="position-absolute" style="bottom:0; left:0; right:0; height:4px; 
